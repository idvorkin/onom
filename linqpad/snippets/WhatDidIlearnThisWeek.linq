...
void DumpYesterdayPage()
{
	...
	contentProcessor.GetTableAfterTitle("SUMMARY", oes).Dump("Summary");
	contentProcessor.GetTableAfterTitle("WORK", oes).Dump("Work");
	contentProcessor.GetTableAfterTitle("HOME", oes).Dump("Home");
	contentProcessor.GetTableAfterTitle("STATS", oes).Dump("Stats");
}
